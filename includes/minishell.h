...
t_parsing *ft_save(t_lexer_data *data, t_parsing *head, t_env *envs, char *content);
...
t_parsing *help_concat(char **concatenated_value,t_parsing *current, t_env *envp ,t_var *data);
...
t_parsing *save_quote_content(t_lexer_data *data, t_parsing *head, char *tmp, t_env *envs);
